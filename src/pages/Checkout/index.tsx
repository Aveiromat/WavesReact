    ...
    <Card title="Pagamento">
      <div>
        <p>
          ...
          confirmação pode levar até 3 dias úteis, devido ao prazos
          estabelecidos pela instituições financeiras. Portanto, a liberação do
        ...
        <Row>
          ...
          <InputGroup>
            <label htmlFor="cardDisplayNumber">Número do cartão</label>
            <input type="text" id="cardDisplayNumber" />
          </InputGroup>
        </Row>
      </div>
    </Card>
